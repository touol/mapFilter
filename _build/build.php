        ...
        foreach ($plugins as $name => $data) {
            ...
            if (!empty($data['events'])) {
                foreach ($data['events'] as $event_name => $event_data) {
                    /** @var modPlugimapFilter $event */
                    $event = $this->modx->newObject('modPlugimapFilter');
...
$install = new mapFilterPackage(MODX_CORE_PATH, $config);
