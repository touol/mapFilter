...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'mapFilter',
                'description' => 'Default source for files of mapFilter',
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'mapfilter_source_default'))) {
